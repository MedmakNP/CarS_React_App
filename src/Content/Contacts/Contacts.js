            ...
            <div className = {classes.container}>
                <div className={classes.wrapper}>
                    ...
                    <div className={classes.inner}>
                        ...
                        <p></p>
                        <a href="https://www.figma.com/file/0NIWEwA3N0YrEMvdnfT2Dy/CarDealership?node-id=113%3A977&t=PoZrAlLbrVhbswlm-0" className={classes.link} >Orignal design</a>
                    </div>
                </div> 
                <div className={classes.wrap}>
                    ...
                    <div className={classes.element}>
                        ...
                        <p className={classes.text}><img src={telephone} className={classes.icon} alt=""/>+91 9979477741</p>
                        <p className={classes.text}><img src={placeholder} className={classes.icon} alt=""/>905-908, Abhijeet-1, Mithakhali Six Roads, Ahmedabad 380006, Gujarat, India</p>
                        <p className={classes.text}><img src={mail} className={classes.icon} alt=""/>tommyshelby156@gmail.com</p>
